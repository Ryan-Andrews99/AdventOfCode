...
public class Day01Test {
    ...
    void itPassesTheTestCasePart1() throws FileNotFoundException {
        assertThat(
                ...
                part01("/java/src/main/java/y2020/Day01/testInput.txt"),
                equalTo(514579));
    }
    ...
    void part1() throws FileNotFoundException {
        assertThat(
                part01("/java/src/main/java/y2020/Day01/input.txt"),
                equalTo(918339));
    }
    ...
    void part2Test() throws FileNotFoundException {
        assertThat(
                part02("/java/src/main/java/y2020/Day01/testInput.txt"),
                equalTo(241861950));
    }
    ...
    void part2() throws FileNotFoundException {
        assertThat(
                part02("/java/src/main/java/y2020/Day01/input.txt"),
                equalTo(23869440));
    }
}
